...
@Entity
@Table(name = "tb_contas_jpa", uniqueConstraints = { @UniqueConstraint(name = "AsContasDevemSerUnicas", columnNames = {
...
public class Conta implements Serializable {
    ...
    public String toString() {
        return String.format("id: %d\nagencia: %d\nnumero_conta: %s\ncodigo_banco: %d", this.id, this.agencia,
                this.numero_conta, this.codigo_banco);
    }
